...
class highlightSql {
  ...
  */
  static protected $colors = Array('chars' => 'grey', 'keywords' => 'blue', 'joins' => 'gray', 'functions' => 'violet', 'constants' => 'red');
  /*
  ...
  */
  static function init($colors = 0) {
    if ($colors) self::$colors = $colors;
  }

  static public function highlight($sql)
  {
    $sql = str_replace('\\\'', '\\&#039;', $sql);
